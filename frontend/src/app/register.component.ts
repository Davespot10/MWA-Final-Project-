    ...
    <mat-card>
      <form [formGroup]="loginForm" (ngSubmit)="signup()" novalidate>
        ...
        <mat-form-field appearance="fill">
          ...
          <input
            matInput
            placeholder="Ex. Belay"
            formControlName="first_name"
            required
          />
          <mat-error> First_Name is required. </mat-error>
        </mat-form-field>
        ...
        <mat-form-field appearance="fill">
          ...
          <input
            matInput
            placeholder="Ex. Hasib"
            formControlName="last_name"
            required
          />
          <mat-error> Last_Name is required. </mat-error>
        </mat-form-field>
        ...
        <mat-form-field appearance="fill">
          ...
          />
          <mat-error> Phone_Number is required. </mat-error>
        </mat-form-field>
  ...
  signup() {
    this.userService
      .signup(
        ...
        this.loginForm.value.first_name as string,
        this.loginForm.value.last_name as string,
        this.loginForm.value.phone_number as string
      )
      .subscribe({
        next: (res: any) => {
